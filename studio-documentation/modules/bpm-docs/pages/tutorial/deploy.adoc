...
image::first-end-event.png[request form]
...
image::nodeMapping-ex.png[Node mapping example]
...
image::node-mapping-process.png[Node mapping process]
...
image::nodeMapping-ex.png[Node mapping process]

En déployant, cette fois ci on a :

image::node-mapping-process-ex.png[Node mapping process]
