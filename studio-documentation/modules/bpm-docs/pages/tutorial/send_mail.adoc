...
image::notification_mail.png[Notification mail]
...
image::complete_nom_send_mail.png[Chose Model]

Renseigner le modèle de mail comme suit :

image::contenu_send_mail.png[Contenu]
