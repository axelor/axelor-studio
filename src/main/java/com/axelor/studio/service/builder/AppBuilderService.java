...
public class AppBuilderService {
  ...
  public AppBuilder build(AppBuilder appBuilder) {
  ...
  private void checkCode(AppBuilder appBuilder) {

    App app = appRepo.findByCode(appBuilder.getCode());

    if (app != null && app != appBuilder.getGeneratedApp()) {
      throw new IllegalStateException(
          String.format(I18n.get(StudioExceptionMessage.APP_BUILDER_1), appBuilder.getCode()));
    }
  }
