...
public class StudioActionScriptService {
  ...
  private void addRootFunction(StudioAction studioAction, StringBuilder stb, int level) {
    ...
    String bindings = addFieldsBinding("target", studioAction.getLines(), level + 1);
    stb.append(bindings);
  ...
  private String addFieldsBinding(String target, List<StudioActionLine> lines, int level) {
  ...
  private String addM2OBinding(StudioActionLine line, boolean search, boolean filter) {
  ...
  private String addM2MBinding(StudioActionLine line) {
  ...
  private String addO2MBinding(StudioActionLine line, String target) {
  ...
  private String addJsonM2OBinding(StudioActionLine line, boolean search, boolean filter) {
