...
public class ChartBuilderService {
   ...
   */
  public void build(ChartBuilder chartBuilder) throws JAXBException {

    if (chartBuilder.getName().contains(" ")) {
      throw new IllegalStateException(I18n.get(StudioExceptionMessage.CHART_BUILDER_1));
    }
   ...
   */
  private String[] prepareQuery(ChartBuilder chartBuilder) {
