...
* Feature #61819: BPM : Multiple menu from a node with roles
* Feature #62138: BPM: Add domain on menus
* Feature #62129: BPM: Open the meta menu form for a menu generated by the process
* Anomaly #62139: BPM: Fix context for menus
* Anomaly #63201: BPM: Fix listout panel issue in View attributes properties
* Anomaly #63443: BPM: Fix single result boolean on the query builder
* Anomaly #63442: BPM: Fix error while use the IN operator in a script generated by the query builder
* Anomaly #64043: BPM: FIx query builder operator on 'Value from' change
