...
const BPMLogo = React.forwardRef<SVGSVGElement>((props, ref) => {
  return (
...
export const Logo = React.memo(function Logo() {
  ...
  const AxelorLogo = React.forwardRef<HTMLDivElement>((props, ref) => {
    return (
      <Box className={styles.axelorLogo} onClick={() => handleOpen("axelor")} ref={ref}>
