...
interface ActionButtonProps {
  onClick: () => void;
  loading: boolean;
  btnPosition?: React.CSSProperties;
  type?: "merge" | "split";
  mergedModel?: unknown;
}
...
const ActionButton = ({
  ...
  return (
    ...
    >
      {!loading ? (
        <Tooltip title={isMerge ? translate("Merge") : translate("Split")}>
          <Box
            style={{
              width: "100%",
              height: "100%",
        ...
        <Tooltip title={isMerge ? translate("Merging...") : translate("Splitting...")}>
          <Box
            style={{
              width: "100%",
              height: "100%",
          ...
          >
            <MaterialIcon icon={"loop" as React.ComponentProps<typeof MaterialIcon>["icon"]} />
          </Box>
        </Tooltip>
      )}
    </Button>
