...
const SplitGuide = () => {
  return (
    <Box p={4} m={4} justifyContent="center" d="flex" flexDirection="column" shadow="lg" rounded>
      {/* Step 1: Select Existing or Upload Custom BPMN Model */}
      <Box as="div" mb={4}>
        <Box as="h5" textAlign="center" fontWeight="bolder" color="body-secondary" mb={4}>
          {" "}
      ...
      <Box as="div" mb={4}>
        ...
        <Box as="p" color="body-tertiary" mb={2}>
          {translate(`Configure the each splitted model by providing a name and unique code.`)}
      ...
      <Box as="div">
        ...
        <Box as="p" color="body-tertiary">
          {translate("After saving the model, click on the button to deploy it.")}
          {
            <Box as="span" p={1} m={1} rounded="circle" border d="inline-flex">
