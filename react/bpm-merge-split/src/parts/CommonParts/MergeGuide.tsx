...
const MergeGuide = () => {
  return (
    <Box p={4} m={4} justifyContent="center" d="flex" flexDirection="column" shadow rounded>
        ...
        <Box textAlign="center" as="p" color="body-tertiary" d="inline" mb={2}>
          {translate("After selecting participants, click on the button.")}{" "}
          {
            <Box
              ...
              style={{ rotate: "-90deg" }}
            >
              <MaterialIcon icon="arrow_and_edge" />
            </Box>
          }
      ...
      <Box as="div" mb={4}>
        ...
        <Box as="p" color="body-tertiary" mb={2}>
          {translate(`Configure the merged model by providing a name and unique code.`)}{" "}
          {
