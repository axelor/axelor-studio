...
- *Icon background* (8): Select a background color for the icon (SingleSelect widget, `studio.menu.icon.background.select`). The available colors are `blue`, `black`, `brown`, `green`, `orange`, `pink`, `purple`, `red`, `violet`, `white`, `yellow`.
