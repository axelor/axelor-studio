...
- *Icon background* (8): Select a background color for the icon from 11 available colors (TagSelect widget): `blue`, `black`, `brown`, `green`, `orange`, `pink`, `purple`, `red`, `violet`, `white`, `yellow`.
