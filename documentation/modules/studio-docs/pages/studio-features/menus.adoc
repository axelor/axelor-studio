...
- *Icon background* (8): Select a background color for the icon from the 11 colors of the `studio.menu.icon.background.select` selection (`SingleSelect` widget): `blue`, `black`, `brown`, `green`, `orange`, `pink`, `purple`, `red`, `violet`, `white`, `yellow`.
