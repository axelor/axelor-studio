...
When enabled, a Studio quick-edit button is displayed in application forms for authorized users, providing a shortcut to open the current view in Studio for editing.
...
| Boolean
| `true`
| Displays the Studio quick-edit button in forms for authorized users
|===
