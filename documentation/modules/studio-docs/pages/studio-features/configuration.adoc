...
* The Apps menu entry is hidden from the Configuration sub-menu.
...
When enabled, a *Studio* quick-edit button is displayed in forms for authorized users, giving them a direct entry point to edit the current view in Studio without leaving the record. Disable it to hide the button for installations where in-form Studio access is not desired.
...
| Boolean
| `true`
| Displays the in-form Studio quick-edit button for authorized users
|===
