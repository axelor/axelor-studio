...
When enabled, a quick-edit *Studio* button is displayed in form views for authorized users, giving direct access to Studio editing from the records they are viewing. Disable it to hide the in-form Studio button.
...
| Boolean
| `true`
| Displays the quick-edit Studio button in form views for authorized users
|===
