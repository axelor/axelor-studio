...
** image:pro-features/connect/connect-scenario.png[connect scenario]
...
** image:pro-features/connect/connect-config.png[connect image]

=== Implementing a Service Task in a BPM Model

** image:pro-features/connect/connect-service-task-config.png[connect service task]
