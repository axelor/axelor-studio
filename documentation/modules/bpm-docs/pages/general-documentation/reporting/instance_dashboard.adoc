...
NOTE: *Resume timer-blocked instances* requires at least one selected row. If none is selected, an error message asks you to select at least one instance blocked on a timer to resume processing.
