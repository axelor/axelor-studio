...
image::warning_builder_bpm.png[event process]
...
image::builder_completed_if.png[event process]
...
image::model_builder_bpm.png[event process]
...
image::line_builder_script.png[event process]
...
image::pizza_select_builder.png[event process]
...
image::expression_builder.png[event process]
...
image::expression_OR_builder.png[event process]
...
image::script_ad_query.png[event process]
...
image::mapper.png[event process]
...
image::mapper_script.png[event process]

Les variables de contexte accessibles sont:

<1> **__date__** : date du jour
<2> **__datetime__**: date et heure du jour
<3> **__user__** : utilisateur connecté
